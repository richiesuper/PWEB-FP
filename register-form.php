...
<body>
	...
	<div class="container w-50 mt-5">
		...
		<form action="register.php" method="post">
			...
			<input type="password" name="password-confirm" id="password-confirm" onkeyup="validate_passwords()" required>
			<button id="submitBtn" type="submit">Register</button>
		</form>
		<span id="warning" class="mt-5 text-center"></span>
		<p class="mt-5 text-center">Already have an account? <a href="login-form.php">Login</a></p>
	</div>
	<script>
